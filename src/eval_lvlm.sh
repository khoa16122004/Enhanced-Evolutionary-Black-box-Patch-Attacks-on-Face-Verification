...
python evaluate_lvlm.py --pretrained llava-onevision-qwen2-7b-ov --model_name llava_qwen --dataset lfw
python evaluate_lvlm.py --pretrained llava-next-interleave-7b --model_name llava_qwen --dataset lfw
